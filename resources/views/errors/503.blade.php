...
<head>
    ...
    <title>Mantenimiento - CETPRO</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .btn-primary {
            background-color: #4f46e5; /* Primario Filament */
            color: white;
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            Estamos realizando mejoras y actualizaciones en la plataforma. Estaremos de vuelta en breve. Agradecemos tu paciencia.
        </p>
        
        <div class="btn-container">
            <a href="javascript:location.reload()" class="btn btn-primary">Reintentar página</a>
        </div>
        
        <div class="info-box">
            <p><strong>¿Qué sucede?</strong></p>
            <ul>
                <li>Se están aplicando actualizaciones del sistema.</li>
                <li>Los datos y accesos se encuentran seguros.</li>
            </ul>
        </div>
    </div>
</body>
